    ...
    public static void main(String[] args) {
        ...
        switch (x) {
            ...
            case 2:
                ...
                String str = String.valueOf(number2); //Storing integer as a String
                //System.out.println(str);
                int index = str.indexOf(".");
                int NumberofDecimalPoints = str.substring(index + 1).length(); //how many Decimal points have in given number2
                ...
                decimalPart = Double.parseDouble(roundOffasString); //round off part as double
            ...
            case 4:
                ...
                String str1 = String.valueOf(number4); //how many Decimal points have in given number2 number2
                //System.out.println(str);
                int index1 = str1.indexOf(".");
                int NumberofDecimalPoints1 = str1.substring(index1 + 1).length();
                double decimalPart1 = number4 - integerPart1;
                String roundOffasString1 = String.format("%." + NumberofDecimalPoints1 + "f", decimalPart1); //decimal part roundoff as String
                decimalPart1 = Double.parseDouble(roundOffasString1); //round off part as double
